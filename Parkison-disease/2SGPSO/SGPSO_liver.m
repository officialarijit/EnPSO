...
if ClassificationRate > 81
    ...
    %% Saving Files
    filename=[strn 'FNNSGPSO_liver POP ' num2str(noP) ' C rate' num2str(ClassificationRate) '.mat'];
    filename1=[strn 'FNNSGPSO_liver POP ' num2str(noP) ' C rate' num2str(ClassificationRate) ' CPlot.fig'];
    filename2=[strn 'FNNSGPSO_liver POP ' num2str(noP) ' C rate' num2str(ClassificationRate) ' Rplot.fig'];
    filename3=[strn 'FNNSGPSO_liver POP ' num2str(noP) ' C rate' num2str(ClassificationRate) ' ROCplot.fig'];
    filename4=[strn 'FNNSGPSO_liver POP ' num2str(noP) ' C rate' num2str(ClassificationRate) ' ConfusionMat plot.fig'];
