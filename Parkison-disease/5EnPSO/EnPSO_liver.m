...
load 2Training_liver.mat
load 1Testing_liver.mat
for ii=1:1
    x=Training;
    ...
    Max_iteration=400;%Maximum number of iterations
    ...
    if ClassificationRate > 75
        ...
        %% Saving Files
        filename=[strn 'FNNEnPSO_liver POP ' num2str(noP) ' C rate' num2str(ClassificationRate) '.mat'];
        filename1=[strn 'FNNEnPSO_liver POP ' num2str(noP) ' C rate' num2str(ClassificationRate) ' CPlot.fig'];
        filename2=[strn 'FNNEnPSO_liver POP ' num2str(noP) ' C rate' num2str(ClassificationRate) ' Rplot.fig'];
        filename3=[strn 'FNNEnPSO_liver POP ' num2str(noP) ' C rate' num2str(ClassificationRate) ' ROCplot.fig'];
        filename4=[strn 'FNNEnPSO_liver POP ' num2str(noP) ' C rate' num2str(ClassificationRate) ' ConfusionMat plot.fig'];
