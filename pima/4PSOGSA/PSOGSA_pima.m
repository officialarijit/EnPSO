...
if ClassificationRate >83
    ...
    %% Saving Files
    filename=[strn 'FNNPSOGSA_pima POP ' num2str(noP) ' C rate' num2str(ClassificationRate) '.mat'];
    filename1=[strn 'FNNPSOGSA_pima POP ' num2str(noP) ' C rate' num2str(ClassificationRate) ' CPlot.fig'];
    filename2=[strn 'FNNPSOGSA_pima POP ' num2str(noP) ' C rate' num2str(ClassificationRate) ' Rplot.fig'];
    filename3=[strn 'FNNPSOGSA_pima POP ' num2str(noP) ' C rate' num2str(ClassificationRate) ' ROCplot.fig'];
    filename4=[strn 'FNNPSOGSA_pima POP ' num2str(noP) ' C rate' num2str(ClassificationRate) ' ConfusionMat plot.fig'];
