...
for Iteration=1:Max_iteration
    ...
    for i=1:size(pos,1)
        for j=1:size(pos,2)
            gc=100;
            %gc=sum(pBest(i,:))/noP; %Geometric Center
...
if ClassificationRate > 81
    ...
    %% Saving Files
    filename=[strn 'FNNSGPSO_pima POP ' num2str(noP) ' C rate' num2str(ClassificationRate) '.mat'];
    filename1=[strn 'FNNSGPSO_pima POP ' num2str(noP) ' C rate' num2str(ClassificationRate) ' CPlot.fig'];
    filename2=[strn 'FNNSGPSO_pima POP ' num2str(noP) ' C rate' num2str(ClassificationRate) ' Rplot.fig'];
    filename3=[strn 'FNNSGPSO_pima POP ' num2str(noP) ' C rate' num2str(ClassificationRate) ' ROCplot.fig'];
    filename4=[strn 'FNNSGPSO_pima POP ' num2str(noP) ' C rate' num2str(ClassificationRate) ' ConfusionMat plot.fig'];
