...
load Training_pima.mat
load Testing_pima.mat
x=Training;
...
if ClassificationRate >79
    ...
    %% Saving Files
    filename=[strn 'FNNEnPSO_pima POP ' num2str(noP) ' C rate' num2str(ClassificationRate) '.mat'];
    filename1=[strn 'FNNEnPSO_pima POP ' num2str(noP) ' C rate' num2str(ClassificationRate) ' CPlot.fig'];
    filename2=[strn 'FNNEnPSO_pima POP ' num2str(noP) ' C rate' num2str(ClassificationRate) ' Rplot.fig'];
    filename3=[strn 'FNNEnPSO_pima POP ' num2str(noP) ' C rate' num2str(ClassificationRate) ' ROCplot.fig'];
    filename4=[strn 'FNNEnPSO_pima POP ' num2str(noP) ' C rate' num2str(ClassificationRate) ' ConfusionMat plot.fig'];
