...
if ClassificationRate > 81
    ...
    %% Saving Files
    filename=[strn 'FNNSGPSO_wine POP ' num2str(noP) ' C rate' num2str(ClassificationRate) '.mat'];
    filename1=[strn 'FNNSGPSO_wine POP ' num2str(noP) ' C rate' num2str(ClassificationRate) ' CPlot.png'];
    filename2=[strn 'FNNSGPSO_wine POP ' num2str(noP) ' C rate' num2str(ClassificationRate) ' Rplot.png'];
    filename3=[strn 'FNNSGPSO_wine POP ' num2str(noP) ' C rate' num2str(ClassificationRate) ' ROCplot.png'];
    filename4=[strn 'FNNSGPSO_wine POP ' num2str(noP) ' C rate' num2str(ClassificationRate) ' ConfusionMat plot.png'];
